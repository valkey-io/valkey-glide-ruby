...
class ValkeyClusterCommandsTest < Minitest::Test
  ...
  def test_cluster_info
    ...
    assert %w[ok fail].include?(result["cluster_state"]), "Cluster state should be ok or fail"
  end
  ...
  def test_cluster_reset
    ...
    pass "Cluster reset failed or timed out as expected: #{e.class}"
  end
